...
# Force rewrite connectLiveFeed in app.js
...
# Logic: use /stream/ws/{name} endpoint.
# Name comes from #stream-name input.
# Token from ACCESS.
# Binary type arraybuffer.
# Update #video src with ObjectURL.
# Toggle #video-placeholder and #live-indicator.
...
print("Forced rewrite of connectLiveFeed")
